...
#upro.l7dah1 .modal-header.label-primary {
  ...
  background-image: url(https://up6.cc/2024/08/172461253324272.png);
  background-size: cover;
}
...
#d2.l7dah1 .label-primary{background-color:#b77c7c!important}#d2.l7dah1 .bg{background-color:#b77c7c!important}#d2.l7dah1 .uzr.d-flex.mm.hmsg{border-radius: 10px 0 10px;background-color: #f3f3f3!important;}#dpnl.l7dah1{background-size: 100%;background-image: url(https://up6.cc/2024/08/172461253324272.png);background-color: #efefef;  }#dpnl.l7dah1 .light{background-color:#878686!important;background-image:linear-gradient(ffdf49,#ffffff 0%,#ebeaea 29%,#fbdcdc 67%,#f7f7f7 100%);}#d0b500.l7dah1 .nosel.fl.bg.{background-color:#d9d0d5!important;  }#users.l7dah1 span.uhash{text-transform:uppercase;background-image:linear-gradient(-225deg,#ededed 0,#f3f3f3 29%,#ebebeb 67%,#ff0018 100%);background-size:220% auto;-webkit-background-clip:text;-webkit-text-fill-color:transparent;animation:2s linear infinite textclip;display:inline-block}
...
#d0.l7dah1 .label-primary {
    ...
    border-radius: 10px 0 10px!important;
    background-image: url(https://up6.cc/2024/08/172461253325913.png);
    color: #ffffff;
    background-size: 100%;
}
...
#upro.l7dah1 .light.fl.pro.break {
    ...
    background-image: url(https://up6.cc/2024/08/172461428846685.png);
    background-size: 100%;
}
#mic.l7dah1 #muteall {
    border-radius: 10px 0 10px;
